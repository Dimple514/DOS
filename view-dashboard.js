...
function renderDashboard() {
  ...
  const sectionRenderers = {
    ...
    kpis: () => {
      return `
      <div class="kpi-grid kpi-scroll" style="display:flex; flex-direction:row; gap:12px; overflow-x:auto; padding-bottom:4px; margin-bottom:0; scrollbar-width:none; -ms-overflow-style:none;">
        <style>
  ...
  main.innerHTML = `
    <div class="dash-wrapper">
      ...
      <div class="quick-actions" style="margin-top:0px; margin-bottom:0px; display:flex; justify-content:space-between; gap:16px; padding:0px 8px 8px 8px;">
        <button class="qa-btn round-icon" onclick="openTaskModal()" title="Add Task" style="width:56px; height:56px; border-radius:50%; padding:0; display:flex; align-items:center; justify-content:center; background:var(--surface-1); border:1px solid var(--border-color); box-shadow:var(--shadow-sm); color:var(--text-1); transition:transform 0.2s;"><i data-lucide="zap" style="width:24px;"></i></button>
        <button class="qa-btn round-icon" onclick="openFinanceAction()" title="Add Expense" style="width:56px; height:56px; border-radius:50%; padding:0; display:flex; align-items:center; justify-content:center; background:var(--surface-1); border:1px solid var(--border-color); box-shadow:var(--shadow-sm); color:var(--text-1); transition:transform 0.2s;"><i data-lucide="wallet" style="width:24px;"></i></button>
        <button class="qa-btn round-icon" onclick="routeTo('calendar'); setTimeout(()=>openEventModal(),500)" title="New Event" style="width:56px; height:56px; border-radius:50%; padding:0; display:flex; align-items:center; justify-content:center; background:var(--surface-1); border:1px solid var(--border-color); box-shadow:var(--shadow-sm); color:var(--text-1); transition:transform 0.2s;"><i data-lucide="calendar" style="width:24px;"></i></button>
        <button class="qa-btn round-icon" onclick="openHabitModal()" title="New Habit" style="width:56px; height:56px; border-radius:50%; padding:0; display:flex; align-items:center; justify-content:center; background:var(--surface-1); border:1px solid var(--border-color); box-shadow:var(--shadow-sm); color:var(--text-1); transition:transform 0.2s;"><i data-lucide="flame" style="width:24px;"></i></button>
      </div>
